...
export class TooltipDirective implements OnInit, OnDestroy {
  ...
  @Input('nuiTooltipDisabled') set disabled(value: boolean) {
  ...
  @Input('nuiTooltipType') type: 'dark' | 'light' = 'dark';
  @Input('nuiTooltipOffset') offset = 8;
  @Input('nuiTooltipPosition') position: 'top' | 'bottom' | 'start' | 'end' =
    'top';
