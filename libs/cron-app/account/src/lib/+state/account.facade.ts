...
export class AccountFacade {
  ...
  public readonly acountIsStripe$ = this._store.select(
    AccountSelectors.selectAcountIsStripe
  );

  public readonly acountCanSubscribePlan$ = this._store.select(
    AccountSelectors.selectAcountCanSubscribePlan
  );
