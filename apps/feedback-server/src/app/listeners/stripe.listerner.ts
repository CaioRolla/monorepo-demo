...
export class StripeListener {
  ...
  public async handleSCustomerSubscriptionDeletedEvent(
    ...
    try {
      ...
      this._logger.error('StripeListener.handleSCustomerSubscriptionDeletedEvent', error);
    }
  }
  ...
  public async handleCheckoutSessionCompletedEvent(
    ...
    try {
      ...
      const { plan, accountId } = data.metadata;
      ...
      this._logger.error('StripeListener.handleCheckoutSessionCompletedEvent', error);
    }
  }
}
